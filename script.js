    ...
    if (selectedModel && selectedYear) {
        ...
        for (const range in modelDimensions) {
            ...
            if (selectedYear >= startYear && selectedYear <= endYear) {
                dimensionsDiv.textContent = selectedMake + ' ' + selectedModel + ' cargo area = ' + JSON.stringify(modelDimensions[range]); // Display dimensions as JSON for clarity
                found = true;
                break;
            }
        }
...
const boxes = [
    { "product_id": 66666666, "product_name": "test", "width": 50.25, "height": 2.75, "depth": 41.25 },
    { "product_id": 60470408, "product_name": "NYSJÖN", "width": 20.25, "height": 2.75, "depth": 31.25 },
    { "product_id": 20400323, "product_name": "SALJEN", "width": 10.75, "height": 2, "depth": 11.25 },
    { "product_id": 50311066, "product_name": "FRIHETEN", "width": 32.75, "height": 16.5, "depth": 55 },
    { "product_id": 40104294, "product_name": "LACK", "width": 25.25, "height": 2.5, "depth": 35.75 },
    { "product_id": 20470047, "product_name": "TIPHEDE", "width": 16.75, "height": 3.5, "depth": 18.75 }
  ];
